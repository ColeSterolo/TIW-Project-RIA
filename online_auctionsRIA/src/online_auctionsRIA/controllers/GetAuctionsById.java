...
public class GetAuctionsById extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String parameterString = request.getParameter("auctionIds");

		try {
			Gson gson = new Gson();
			Integer[] integers = gson.fromJson(parameterString, Integer[].class);
		...
		Gson gsonBuilder = new GsonBuilder().setDateFormat("yyyy MMM dd").create();
		String json = gsonBuilder.toJson(auctionBeans);
